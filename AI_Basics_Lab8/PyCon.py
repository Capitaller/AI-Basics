...
class PyCon:
    def __init__(self, screen, rect, functions=None, key_calls=None, vari=None, syntax=None):
        self.message_of_the_day = ["Pacman operating Console"]
        ...
        self.add_functions_calls({"help": self.help,"clear": self.clear})
    ...
    def help(self, *args):
        if args:
            ...
            for i, v in items:
                out = i + ": Takes %d arguments. " % (v.__code__.co_argcount - (v.__code__.co_varnames[0] == "self"))
                doc = v.__doc__
                if doc:
